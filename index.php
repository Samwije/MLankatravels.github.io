            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                        <a href="video/video2.mp4" class="icon-video popup-vimeo d-flex align-items-center justify-content-center mb-4" type="video/mp4">
            ...
            <div class="container">
                <div class="row d-flex">
                    <div class="col-md-6 d-flex">
                        <div class="img d-flex align-self-auto" style="background-image:url(images/waterfall.jpg);"></div>
                    </div>
                    <div class="col-md-6 pl-md-5 py-5">
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section ftco-animate">
                                <h2 class="mb-4">Make Your Tour Memorable and Safe With Us</h2>
                                <p>MLanka Travel (pvt) Ltd is happy to invite you on an unforgettable holiday in Sri Lanka,
                                    one of the most ancient and captivating countries countries in the world. If you are and
                                    avid traveller with a person for unique countries, breathtaking landscapes and palm
                                    fringed beaches, Sri Lanka holidays offer all this and more.</p>

                                <p>Changes of landscape, climate and terrain every 2.5 hours drive is truly amazing,
                                    making for a remarkable tropical escape. Travel around this beautiful country at ease
                                    with special travel packages as the friendly and professional hosts of MLanka Tours will
                                    introduce you to the unmatched charm of this island in the indian Ocean, a truly
                                    awe-inspiring destination.</p>
...
<!--        <section class="ftco-section testimony-section bg-bottom" style="background-image: url(images/bg_3.jpg);">
                                ...
                                <div class="testimony-wrap py-4">
                                    <div class="text">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="user-img" style="background-image: url(images/mlwate.jpg)"></div>
                                            <div class="pl-3">
                                                <p class="name">4 Wate Tour Agency</p>
                            ...
                            <div class="item">
                                <div class="testimony-wrap py-4">
                                    <div class="text">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="user-img" style="background-image: url(images/mlspice.jpg)"></div>
                                            <div class="pl-3">
                                                <p class="name">4 Wate Spices</p>
                                                <span class="position">Marketing Manager</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimony-wrap py-4">
                                    <div class="text">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="user-img" style="background-image: url(images/ml.jpg)"></div>
                                            <div class="pl-3">
                                                <p class="name">M Lanka Travels</p>
                                                <span class="position">Marketing Manager</span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="ftco-section">
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        <h2 class="mb-4">One’s destination is never a place, but a new way of seeing things.</h2>
                    </div>
                </div>
                <div class="row d-flex">
                    <div class="col-md-4 d-flex ftco-animate">
                        <div class="blog-entry ">
                            ...
                            <video width="400" height="200" controls="controls" type="video/mp4" preload="none">
                                <source src="video/video2.mp4" autostart="false">
                            ...
                            <div class="text mt-3 float-right d-block">
                                ...
                                <h3 class="heading"><a href="#">One’s destination is never a place, but a new way of seeing things.</a></h3>
                                <p>The main purpose of visiting the country by tourists is to have pleasure. During vacations, most of the tourists come to the country to engage in various entertaining activities such as visiting beaches for swimming surfing, boating, fishing, jungle tracking for rock climbing, hiking, wild life seeing , bird watching, and so on.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex ftco-animate">
                        <div class="blog-entry justify-content-end">
                            ...
                            <div class="text mt-3 float-right d-block">
                                ...
                                <h3 class="heading"><a href="#">The traveler sees what he sees, the tourist sees what he has come to see.</a></h3>
                                <p>Like all great travellers, You have seen more than you remember, and remember more than you have seen.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex ftco-animate">
