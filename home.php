...
$s = "select username from register where email = '$email' ";
...
//                    true
                    ...
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <!--<li class="nav-item"><a href="blog.php" class="nav-link">Blog</a></li>-->
                            <li class="nav-item"><a href="contact.php" class="nav-link">Contact</a></li>
                            <li class="nav-item active"><a href="home.php" class="nav-link">Admin</a></li>
            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                        <a href="video/video2.mp4" class="icon-video popup-vimeo d-flex align-items-center justify-content-center mb-4">
        ...
        <section class="ftco-section">
            <div class="search-wrap-1 ftco-animate p-2">
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><button type="button" data-toggle="modal" data-target="#wildlifebiginfivedays" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#wildlifechasetojungle" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#wildlifeexploredeepjungle" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#halalmistyhils" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#halalfamilytours" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#halalteacounty" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#honeymoonromanticholiday" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#honeymoonromanticgateway" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#honeymoonfeelthelove" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#specialluxuryholiday" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#specialbuddhisttour" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#specialcasinonightlife" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <ul>
                                    ...
                                    <li><span class="flaticon-route"></span></li>
                                    <li><span class="flaticon-king-size"></span></li>
                                    <li><button type="button" data-toggle="modal" data-target="#speciallinclusivetour" class="btn btn-warning" style="background-color: #f9ab30">Update Details</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <form action="savemistyhils.php" method="POST">
<?php
$s = "select * from mistyhils";
...
if ($mhnumrow == 1) {
    while ($ro = mysqli_fetch_array($resmistyhils)) {
        ...
        ?>
                                        <label style="margin-left: 400px;">Starting From USD <input style="width: 80px;" type="number" value="<?php print $stfrmistyhils; ?>" placeholder="195" name="startfrom" required> Per Person</label>
                                        <?php
                                    }
                                } else {
                                    ?>
                                    <label style="margin-left: 400px;">Starting From USD <input style="width: 80px;" type="number" placeholder="195" name="startfrom" required> Per Person</label>
                                    <?php
                                }
                                ?>
                                <br>
...
if ($mhnumrow == 1) {
    ...
    while ($row = mysqli_fetch_array($resmistyhils)) {
        ?>
                                        <tr>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax2x']; ?>" placeholder="195" name="pass2x" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax3x']; ?>" placeholder="195" name="pass3x" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax46x']; ?>" placeholder="195" name="pass46x" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax79x']; ?>" placeholder="195" name="pass79x" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax1015x']; ?>" placeholder="195" name="pass1015x" required> Per Person</td>
                                        </tr>
                                    </table><br>
                                    <span style="margin-left: 300px;">Rait Valid until <input style="width: 60px;" value="<?php print $row['datex']; ?>" type="number" placeholder="30" name="datex">.<input style="width: 110px;" type="text" value="<?php print $row['monthx']; ?>" placeholder="November" name="monthx">.<input style="width: 80px;" type="number" value="<?php print $row['yearx']; ?>" placeholder="2020" name="yearx"></span>
    ...
    ?>
                                ...
                                <tr>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass2x" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass3x" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass46x" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass79x" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass1015x" required> Per Person</td>
                                </tr>
                                </table><br>
                                <span style="margin-left: 300px;">Rait Valid until <input style="width: 60px;" type="number" placeholder="00" name="datex">.<input style="width: 110px;" type="text" placeholder="November" name="monthx">.<input style="width: 80px;" type="number" placeholder="0000" name="yearx"></span>
...
if ($mhnumrow == 1) {
    ...
    while ($row = mysqli_fetch_array($resmistyhils)) {
        ?>
                                        <tr>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax2y']; ?>" placeholder="195" name="pass2y" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax3y']; ?>" placeholder="195" name="pass3y" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax46y']; ?>" placeholder="195" name="pass46y" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax79y']; ?>" placeholder="195" name="pass79y" required> Per Person</td>
                                            <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax1015y']; ?>" placeholder="195" name="pass1015y" required> Per Person</td>
                                        </tr>

                                    </table><br>
                                    <span style="margin-left: 300px;">Rait Valid until <input style="width: 60px;" type="number" value="<?php print $row['datey']; ?>" placeholder="30" name="datey">.<input style="width: 110px;" type="text" value="<?php print $row['monthy']; ?>" placeholder="November" name="monthy">.<input style="width: 80px;" type="number" value="<?php print $row['yeary'] ?>" placeholder="2020" name="yeary"></span>
        <?php
    }
} else {
    ?>
                                <tr>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass2y" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass3y" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass46y" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass79y" required> Per Person</td>
                                    <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass1015y" required> Per Person</td>
                                </tr>

                                </table><br>
                                <span style="margin-left: 300px;">Rait Valid until <input style="width: 60px;" type="number" placeholder="00" name="datey">.<input style="width: 110px;" type="text" placeholder="November" name="monthy">.<input style="width: 80px;" type="number" placeholder="0000" name="yeary"></span>
...
?>
            <div class="modal fade text-body" id="halalfamilytours" tabindex="2" role="dialog" aria-labelledby="exampleModalLongTitlel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content container">
                        <div class="modal-header row justify-content-sm-start">
                            <div class="col-md-12">
...
if ($fmnumrow == 1) {
    while ($ro = mysqli_fetch_array($resfamilytours)) {
        ...
        ?>
                                        <label style="margin-left: 400px;">Starting From USD <input style="width: 80px;" type="number" value="<?php print $stfrfamilytour; ?>" placeholder="000" name="startfrom" required> Per Person</label>
                                        <?php
                                    }
                                } else {
                                    ?>
                                    <label style="margin-left: 400px;">Starting From USD <input style="width: 80px;" type="number" placeholder="000" name="startfrom" required> Per Person</label>
                                    <?php
                                }
                                ?>
                                <br>
...
if ($numberofrow == 1) {
    while ($ro = mysqli_fetch_array($result)) {
        $startfrom = $ro['startfrom'];
        ?>
                                                    <label style="margin-left: 400px;">Starting From USD <input style="width: 80px;" type="number" value="<?php print $startfrom; ?>" placeholder="000" name="startfrom" required> Per Person</label>
                                                    <?php
                                                }
                                            } else {
                                                ?>
...
if ($numberofrow == 1) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ?>
                                                    <tr>
                                                        <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax2z']; ?>" placeholder="195" name="pass2z" required> Per Person</td>
                                                        <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax3z']; ?>" placeholder="195" name="pass3z" required> Per Person</td>
                                                        <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax46z']; ?>" placeholder="195" name="pass46z" required> Per Person</td>
                                                        <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax79z']; ?>" placeholder="195" name="pass79z" required> Per Person</td>
                                                        <td>$<input style="width: 80px;" type="number" value="<?php print $row['pax1015z']; ?>" placeholder="195" name="pass1015z" required> Per Person</td>
                                                    </tr>

                                                </table><br>
                                                <span style="margin-left: 300px;">Rait Valid until <input style="width: 60px;" type="number" value="<?php print $row['datez']; ?>" placeholder="30" name="datez">.<input style="width: 110px;" type="text" value="<?php print $row['monthz']; ?>" placeholder="November" name="monthz">.<input style="width: 80px;" type="number" value="<?php print $row['yearz'] ?>" placeholder="2020" name="yearz"></span>
        <?php
    }
} else {
    ?>
                                            <tr>
                                                <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass2z" required> Per Person</td>
                                                <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass3z" required> Per Person</td>
                                                <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass46z" required> Per Person</td>
                                                <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass79z" required> Per Person</td>
                                                <td>$<input style="width: 80px;" type="number" placeholder="000" name="pass1015z" required> Per Person</td>
                                            </tr>

                                            </table><br>
                                            <span style="margin-left: 300px;">Rait Valid until <input style="width: 60px;" type="number" placeholder="00" name="datez">.<input style="width: 110px;" type="text" placeholder="November" name="monthz">.<input style="width: 80px;" type="number" placeholder="0000" name="yearz"></span>
...
if ($numberofrow == 1) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ?>
                                                    <tr>
                                                        <td>$<input style="width: 80px;" type="number" value="<?php print $row['couplex']; ?>" placeholder="195" name="couplex" required> for Couple</td>
                                                    </tr>
                                                </table><br>
                                                <span style="margin-left: 000px;">Rait Valid until <input style="width: 60px;" value="<?php print $row['datex']; ?>" type="number" placeholder="30" name="datex">.<input style="width: 110px;" type="text" value="<?php print $row['monthx']; ?>" placeholder="November" name="monthx">.<input style="width: 80px;" type="number" value="<?php print $row['yearx']; ?>" placeholder="2020" name="yearx"></span>
    ...
    ?>
                                            ...
                                            <tr>
                                                <td>$<input style="width: 80px;" type="number" placeholder="000" name="couplex" required> for Couple</td>
                                            </tr>
                                            </table><br>
                                            <span style="margin-left: 00px;">Rait Valid until <input style="width: 60px;" type="number" placeholder="00" name="datex">.<input style="width: 110px;" type="text" placeholder="November" name="monthx">.<input style="width: 80px;" type="number" placeholder="0000" name="yearx"></span>
...
if ($numberofrow == 1) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ?>
                                                    <tr>
                                                        <td>$<input style="width: 80px;" type="number" value="<?php print $row['coupley']; ?>" placeholder="195" name="coupley" required> for Couple</td>
                                                    </tr>

                                                </table><br>
                                                <span style="margin-left: 00px;">Rait Valid until <input style="width: 60px;" type="number" value="<?php print $row['datey']; ?>" placeholder="30" name="datey">.<input style="width: 110px;" type="text" value="<?php print $row['monthy']; ?>" placeholder="November" name="monthy">.<input style="width: 80px;" type="number" value="<?php print $row['yeary'] ?>" placeholder="2020" name="yeary"></span>
        <?php
    }
} else {
    ?>
                                            <tr>
                                                <td>$<input style="width: 80px;" type="number" placeholder="000" name="coupley" required> for Couple</td>
                                            </tr>

                                            </table><br>
                                            <span style="margin-left: 00px;">Rait Valid until <input style="width: 60px;" type="number" placeholder="00" name="datey">.<input style="width: 110px;" type="text" placeholder="November" name="monthy">.<input style="width: 80px;" type="number" placeholder="0000" name="yeary"></span>
